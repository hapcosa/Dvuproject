...
ROLES: Final[tuple[str, ...]] = (ADMIN, EDITOR, VENDEDOR, CLIENTE, BODEGA)
...
#: `cliente` y `bodega` tampoco están: no se pidieron, y un rol que nadie usa en una
#: lista desplegable es una forma de equivocarse.
